export default {
  common: {
    ...
    reset_when_wilddog_too_many_connections:
      "Switching to a standby database, too many connections to the current database. Note: omments data are not shared between main & standby databases.",
    unknown_ip: "Unknown IP address",
    unknown_user: "Unknown User",
    wilddog_too_many_connections:
      "The current database had too many connections, please contact the site admin.",
  ...
  AdminHelpers: {
    ...
    confirm: {
      resetting_discussion_count_for_all_pages:
        "Are you sure to reset discussion count for all pages?",
    },
    error: {
    ...
    success: {
      resetting_discussion_count_for_all_pages:
        "Successfully reset discussion count for all pages!",
    },
    tab: {
      helpers: "Helpers",
    },
    text: {
      desc_resetting_discussion_count_for_all_pages:
        "If the discusstion count for your webpage went wrong, you can reset discussion count for all pages with this helper function.",
  ...
  PersonalCenter: {
    ...
    text: {
      ...
      new_comment_on_page:
        'Someone posted new comment on <a href="{{pageURL}}" target="blank">{{pageTitle}}</a>.',
      "new_comment_on_page+":
        '<a title="{{email}}">{{displayName}}</a> posted <a title="{{content}}">new comment</a> on <a href="{{pageURL}}" title="Click to visit {{pageTitle}}" target="blank">{{pageTitle}}</a>.',
      new_reply_to_comment: "Someone posted new reply your comment.",
      "new_reply_to_comment+":
        '<a title="{{email}}">{{displayName}}</a> posted <a title="{{content}}">new reply</a> to your comment.',
      new_disc_in_comment: "Someone posted new reply in the discussion of your comment.",
      "new_disc_in_comment+":
        '<a title="{{email}}">{{displayName}}</a> posted <a title="{{content}}">new reply</a> in the discussion of your comment.',
      new_mention: "Someone mentioned you in comment.",
      "new_mention+":
        '<a title="{{email}}">{{displayName}}</a> mentioned you in <a title="{{content}}">comment</a>.',
      notif_doesnt_exist: "Notification doesn't exist.",
      related_content_no_longer_exists: "Related content no longer exists.",
      tips:
        "view more information by hovering your mouse on the highlighted text; open related webpage by clicking Details button.",
    },
  },
  Plugin: {
    error: {
